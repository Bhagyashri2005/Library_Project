...
//         { params: filters }
//       );
//       setMemberPie(res.data);
//     } catch (err) {
//       console.error("Failed to load member chart", err);
//     }
//   };
...
//       setErr("");
//       try {
//         const [sRes, logsRes, chartsRes] = await Promise.all([
//   axios.get("http://127.0.0.1:8000/admin/summary"),
//   axios.get("http://127.0.0.1:8000/admin/logs/recent"),
//   axios.get("http://127.0.0.1:8000/admin/stats/charts"),
// ]);

// setSummary(sRes.data);
// setRecentLogs(logsRes.data.data || []);   // <-- FIXED HERE
...
//   useEffect(() => {
//     axios
//       .get("http://127.0.0.1:8000/admin/filters")
//       .then((res) => {
...
//   // Pie data: students vs teachers
//   // const memberPie = [
//   //   { name: "Students", value: charts?.members?.students || 0 },
//   //   { name: "Teachers", value: charts?.members?.teachers || 0 },
//   // ];

//   const entryExit = [
//     { name: "Today", entry: charts?.today?.entry || 0, exit: charts?.today?.exit || 0 },
//   ];
...
//                 onClick={() => {
//                   const params = { ...memberFilters };

//                   // If teacher → remove year & division
//                   if (memberFilters.memberType === "teacher") {
//                     delete params.year;
